  ...
  <div className="frame">
    ...
    <div ng-app ng-init="checked = false">
          ...
          <div className="btn-animate">
            <Link to="/blogs" className="btn-signin">Sign in</Link>
          </div>
				        </form>
          ...
          <a ng-click="checked = !checked" className="btn-signup">Sign Up</a>
            ...
            <div  className="success">
              {/* <svg width="270" height="270" xmlns="http://www.w3.org/2000/svg" a="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
{/*       
  ...
  {/* <a id="refresh" value="Refresh" onClick="history.go()"> */}
    {/* <svg className="refreshicon"   version="1.1" id="Capa_1"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
